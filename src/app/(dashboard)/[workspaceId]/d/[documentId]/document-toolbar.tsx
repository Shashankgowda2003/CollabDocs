  ...
  return (
    <>
      <div className="flex items-center gap-1">
        ...
        <button onClick={async () => { await toggleFavorite(documentId); router.refresh(); }} className="rounded-xl p-2 text-zinc-500 hover:text-yellow-500 hover:bg-yellow-50 dark:hover:bg-yellow-500/10 transition-all" title="Favorite">
